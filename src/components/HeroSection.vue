<template>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div class="lg:col-span-7 space-y-6">
          ...
          <div class="flex flex-wrap items-center gap-3 pt-2">
            <a
              href="#experience"
              class="px-6 py-3 rounded-xl bg-amber-500 text-slate-950 font-bold text-xs hover:bg-amber-400 transition-all shadow-lg shadow-amber-500/20 flex items-center space-x-2 cursor-pointer"
            >
  ...
  "location": "Belfast, Northern Ireland"
              ...
              <form @submit.prevent="executeCommand" class="flex items-center space-x-2 pt-1">
                <span class="text-amber-400">ronan@belfast-dev:~$</span>
                <input
